    ...
    fun completeLogin() {
        lifecycleScope.launch {
            ...
            try {
                ...
                Log.e("LoginActivity", "Schedule generation error: ${e.localizedMessage}")
            }

            try {
                loginViewModel.autoGenerateDailySummaries()
            } catch (e: Exception) {
                Log.e("LoginActivity", "DailySummary generation error: ${e.localizedMessage}")
            }
