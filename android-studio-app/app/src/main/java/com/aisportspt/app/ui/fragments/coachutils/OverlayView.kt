...
class OverlayView(context: Context?, attrs: AttributeSet?) :
    ...
    override fun draw(canvas: Canvas) {
        ...
        results?.let { poseLandmarkerResult ->
            ...
            canvas.drawText(
                "${leftAngle.toInt()}°",
                leftKnee.x() * imageWidth * scaleFactor + offsetX,
                leftKnee.y() * imageHeight * scaleFactor - 20 + offsetY,
                textPaint
            )
            ...
            canvas.drawText(
                "${rightAngle.toInt()}°",
                rightKnee.x() * imageWidth * scaleFactor + offsetX,
                rightKnee.y() * imageHeight * scaleFactor - 20 + offsetY,
                textPaint
            )
        }
    }
