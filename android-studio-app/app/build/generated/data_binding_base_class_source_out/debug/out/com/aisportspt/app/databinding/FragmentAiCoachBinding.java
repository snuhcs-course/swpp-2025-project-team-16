...
import com.aisportspt.app.ui.fragments.coachutils.OverlayView;
...
public final class FragmentAiCoachBinding implements ViewBinding {
  ...
  private FragmentAiCoachBinding(@NonNull LinearLayout rootView, @NonNull FrameLayout aiGuideArea,
      ...
      @NonNull LinearLayout emptyFeedbackLayout, @NonNull OverlayView overlay,
      @NonNull LinearLayout phaseIndicator, @NonNull ProgressBar progressScore,
      @NonNull LinearLayout recordingIndicator, @NonNull Spinner spinnerSport,
      @NonNull TextView textAccuracyPercent, @NonNull TextView textCurrentPhase,
  ...
  public static FragmentAiCoachBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAiCoachBinding((LinearLayout) rootView, aiGuideArea, btnFlipCamera,
          btnReset, btnStartAnalysis, cameraPreview, emptyFeedbackLayout, overlay, phaseIndicator,
